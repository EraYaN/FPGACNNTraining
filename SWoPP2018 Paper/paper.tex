...
The main dataset used was MNIST, so 784 input features.
...
\begin{table}[h]
  ...
  \begin{tabular}{ll}
    ...
    \midrule
    128$\times$128 & \num{0}  \\ % Too big
    100$\times$100 & \num{0} \\ % Too big (86 is also too big)
    84$\times$84 & \num{0}  \\
    64$\times$64 & \num{17.8}  \\ % kernel_nn_blocking_B64inorder_hw_2018-06-28T22.52.27.aocx Network: [28 * 28, 512, 512, 10]
    32$\times$32 & \num{0}  \\
    16$\times$16 & \num{4.3}  \\ % kernel_nn_blocking_B16inorder_hw_2018-06-28T22.53.27.aocx Network: [28 * 28, 512, 512, 10]
    \bottomrule
  \end{tabular}
\end{table}
